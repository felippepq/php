...
<head>
        ...
        <body>
            ...
            <form class="form-horizontal" action="calcula.php" method="post" style="padding: 15px">
                <fieldset>
                ...
                <div class="col-md-4">
                <input id="altura" name="altura" type="text" placeholder="Digite a altura" class="form-control input-md" required="">
